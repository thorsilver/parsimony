...
def writeAssemblesUpToX(x, builtinSymbol):
    if x >= 1:
        ...
        output.write("// Auto-generated code for function " + builtinSymbol + "assembleList1\n")
        ...
        for i in range(2, x+1):
            ...
            output.write("// LPP list format assumed\n\n")
            output.write("function " + builtinSymbol + "listAssemble" + str(i-1) + " x " + \
                listSum(["i" + str(j) + " " for j in range(i-1)]) + "\n")
            output.write("function " + builtinSymbol + "appendTo x i" + str(i-1) + "\n")
            output.write("return\n")    
